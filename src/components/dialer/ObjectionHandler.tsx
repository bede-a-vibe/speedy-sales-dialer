...
const CATEGORY_COLOURS: Record<ObjectionScript["category"], string> = {
  price: "bg-red-500/10 text-red-700 dark:text-red-400 border-red-500/20",
  timing: "bg-yellow-500/10 text-amber-800 dark:text-yellow-400 border-yellow-500/20",
  trust: "bg-blue-500/10 text-blue-700 dark:text-blue-400 border-blue-500/20",
  competition: "bg-purple-500/10 text-purple-700 dark:text-purple-400 border-purple-500/20",
  authority: "bg-orange-500/10 text-orange-700 dark:text-orange-400 border-orange-500/20",
  need: "bg-green-500/10 text-green-700 dark:text-green-400 border-green-500/20",
};
