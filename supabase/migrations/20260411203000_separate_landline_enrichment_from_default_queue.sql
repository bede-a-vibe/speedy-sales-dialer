-- Keep landline/business-line records out of the default dialer queue unless
-- a decision-maker direct number is already captured.
--
-- This preserves intentional access via the explicit phone_type filter while
-- separating likely enrichment candidates from true DNC and the normal dialer flow.
