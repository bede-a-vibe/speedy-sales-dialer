CREATE OR REPLACE FUNCTION public.claim_dialer_leads(_session_id uuid, _industry text DEFAULT NULL::text, _state text DEFAULT NULL::text, _claim_size integer DEFAULT 25, _lock_minutes integer DEFAULT 15)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
